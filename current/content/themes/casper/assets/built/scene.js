...
import { ShaderPass } from './three/examples/jsm/postprocessing/ShaderPass.js';
    ...
    var img = document.querySelector(".warp");
    ...
    function init() {
      ...
      var myEffect = {
        uniforms: {
          "tDiffuse": { value: null },
          "resolution": { value: new THREE.Vector2(0.5,(window.innerHeight/window.innerWidth)/2) },
        ...
        void main()  {
            ...
            float b = texture2D(tDiffuse, newUV.xy += c * (0.1 * .2)).z;
